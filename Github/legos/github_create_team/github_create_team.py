...
class InputSchema(BaseModel):
    ...
    privacy: Optional[GithubTeamPrivacy] = Field(
        description='Privacy type to be given to the team. "secret" - only visible to organization owners and members of this team, "closed"- visible to all members of this organization. By default type "secret" will be considered. ', 
        title='Privacy'
    )
...
def github_create_team(handle, organization_name:str, team_name:str,repositories:list, privacy:GithubTeamPrivacy=GithubTeamPrivacy.secret, description:str="") -> Dict:
    """github_create_team returns details of newly created team.
        ...
        :param repositories: List of the GitHub repositories to add to the new team. Eg: ["repo1","repo2"]
