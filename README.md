...
| ------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------ |
| .ipynb_checkpoints | [Generate readme checkpoint](https://github.com/unskript/Awesome-CloudOps-Automation/tree/master/.ipynb_checkpoints/generate_readme-checkpoint.ipynb) | [Open in browser](http://127.0.0.1:8888/lab/tree/generate_readme-checkpoint.ipynb)
